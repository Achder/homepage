  ...
  onChangeDirection(event: KeyboardEvent) {
	...
	draw() {
		...
		while(segment) {
			...
			ctx.fillRect(segment.x * this.segmentSize, segment.y * this.segmentSize, this.segmentSize, this.segmentSize)
			ctx.strokeStyle = "white"
			ctx.lineWidth = this.segmentBorder
			ctx.strokeRect(segment.x * this.segmentSize, segment.y * this.segmentSize, this.segmentSize, this.segmentSize)
		...
		ctx.fillRect(target.x * this.segmentSize, target.y * this.segmentSize, this.segmentSize, this.segmentSize)
		ctx.strokeStyle = "white"
		ctx.lineWidth = this.segmentBorder
		ctx.strokeRect(target.x * this.segmentSize, target.y * this.segmentSize, this.segmentSize, this.segmentSize)
	}
